    ...
    <div class="flex flex-center justify-around bg-gray-100">
      ...
      <div class="w-5/6 px-8 py-16">
        ...
        <form @submit.prevent="create" class="w-3/4 mt-6">
          ...
          <div class="mb-4">
            <label class="block text-gray-800 text-xl font-bold mb-2" for="avatar">Logo</label>
            <input
              ...
              autofocus
            />
            <small v-if="errors.avatar" class="mt-2 text-red-500">{{ errors.avatar[0] }}</small>
          </div>
          <div class="mb-4">
            <label class="block text-gray-800 text-xl font-bold mb-2" for="description">Description</label>
            <input
              ...
              autofocus
            />
            <small v-if="errors.description" class="mt-2 text-red-500">{{ errors.description[0] }}</small>
          </div>
          <div class="mb-4">
            <label class="block text-gray-800 text-xl font-bold mb-2" for="phone">Phone</label>
            <input
              ...
              autofocus
            />
            <small v-if="errors.phone" class="mt-2 text-red-500">{{ errors.phone[0] }}</small>
          </div>
...
export default {
  ...
  methods: {
    async create() {
      ...
      this.$router.push({
        path: this.$route.query.redirect || '/profile/vendors'
      })
    }
  }
}
